...
int main(int argc, char *argv [])
{
    ...
    if (argv_index_input < 0 || argv_index_xsize < 0 || argv_index_ysize < 0 || 
        argv_index_channels < 0 || argv_index_quality < 0 || argv_index_output < 0)
    {
    ...
    int img_quality_desired = atoi(argv[argv_index_quality]);
    ...
    rc = stbir_resize_uint8(img_buffer, img_xsize, img_ysize, 0, img_buffer_resized, img_xsize_target, img_ysize_target, 0, img_channels_desired);
    ...
    else
    {
        ...
        /* write image to file */
        rc = stbi_write_jpg(argv[argv_index_output], img_xsize_target, img_ysize_target, img_channels_desired, (void *)img_buffer_resized, img_quality_desired);
    }
